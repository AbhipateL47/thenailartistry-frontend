...
import { orderService, ShippingAddress } from '@/features/orders/services/order.service';
import { userService, Address } from '@/features/profile/services/user.service';
import { paymentService } from '@/features/orders/services/payment.service';
import { generateDummyAddress } from '@/shared/utils/dummyAddress';
import { generateIdempotencyKey } from '@/shared/utils/generateIdempotencyKey';
import { RazorpayCheckout } from '@/features/orders/components/payment/RazorpayCheckout';
import { OTPLoginModal } from '@/features/auth/components/OTPLoginModal';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <form ref={formRef} onSubmit={handleSubmit(onSubmit)}>
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid lg:grid-cols-[1fr,400px] gap-8 max-w-7xl mx-auto mt-6">
            {/* Left Column - Forms */}
