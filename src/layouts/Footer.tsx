...
import { Facebook, Instagram, Youtube, Phone, Mail, Shield, RotateCcw, Truck, Star } from 'lucide-react';
  ...
  return (
    <footer className="bg-secondary border-t border-border">
      <div className="container mx-auto p-4">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-muted-foreground mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>info@thenailartistry.store</span>
              </div>
            </div>
        ...
        {/* Trust badges */}
        <div className="border-t border-border mt-8 pt-6 flex flex-wrap justify-center gap-6 mb-6">
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>4.9 Rated by Customers</span>
          </div>
        </div>
